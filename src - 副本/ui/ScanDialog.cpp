...
void ScanDialog::setupUi() {
    ...
    if (resultTableView) {
        connect(resultTableView->horizontalHeader(), &QHeaderView::sectionResized, this, [this, resultTableView](int logicalIndex, int , int newSize) {
...
void ScanDialog::onDriveContextMenu(const QString& drive, const QPoint& ) {
    QMenu menu(this);
